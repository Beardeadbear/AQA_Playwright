 ...
 * If it is not there, drop using DND 3.0. the same component again
...
exports.command = function(component) {
  ...
  return this
    ...
    .waitForElementPresentWithoutErrors(widgetOnPreviewScreenLocator, this.globals.smallWait, resultDisplaying)
    .perform(function() {
      if (resultDisplaying[0] == false) {
        this.api.frame(null)
          .newDragAndDrop(component)
      }
    })
    .frame(null)
    .switchToPreviewFrame()
    ...
    .frameParent()
    .waitForElementPresentWithoutErrors(widgetInterfaceShowLocator, this.globals.smallWait, resultDisplaying)
    .perform(function() {
