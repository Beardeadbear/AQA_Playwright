/**
 * Command to check if click on element returned the expected result in the form of disappeared element
 * @param {String} selectorToClickOn - css selector to element which should be clicked
 * @param {String} selectorToExpect - css selector to element which should be not present after performed click
 */
