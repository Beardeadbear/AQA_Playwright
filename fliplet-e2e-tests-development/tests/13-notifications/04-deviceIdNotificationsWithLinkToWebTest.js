...
module.exports = {
  ...
  before: function (browser, done) {
    browser.globals.appNameGenerated = `${casual.letter} ${casual.word} ${casual.letter} 04-notif`;
  ...
  'Return to studio and open Notifications settings from apps page': function (browser) {
    ...
    appsPage.navigate()
      ...
      .openNotificationsByAppName(browser.globals.appNameGenerated);

    notificationOverlay.assertNotificationOverlayIsOpen()
      .clickCreateNewButton();
  },

  'Check "Configure your notification" section with link to web page': function (browser) {
    const notificationOverlay = browser.page.notificationOverlay();
    ...
    notificationOverlay.checkNotificationSectionIsDisplay('Configure your notification', 1)
      ...
      .enterWebPageForLinkToWeb(notificationValues.webPageForLink)
      .clickNextButton();
  },
  ...
  'Check "Send notification to..." section': function (browser) {
    ...
    notificationOverlay.checkNotificationSectionIsDisplay('Send notification to...', 2)
      ...
      .enterDeviceIdForRecipients(deviceId[deviceId.length - 1])
      .setNotesForNotification(notificationValues.notes);
  },

  'Check "Back" button functionality': function (browser) {
    const notificationOverlay = browser.page.notificationOverlay();

    notificationOverlay.clickBackButton()
      ...
      .clickNextButton()
      .checkNotificationSectionIsDisplay('Send notification to...', 2)
  ...
  'Check a new notification details in the list of notifications': function (browser) {
    ...
    notificationOverlay.checkNotificationMessageIsInTheList(notificationValues.notificationMessage)
      ...
      .checkNotificationActionLink(notificationValues.webPageForLink);
  },
  ...
  'Check a new notification in the application on web': function (browser) {
    ...
    webApp.switchToOpenWindowByNumber(2)
      ...
      .switchToNewWindow('@notificationTitle', notificationValues.webPageForLink, 3);
  },

  'Return to studio and delete the notification': function (browser) {
    const notificationOverlay = browser.page.notificationOverlay();
    const webApp = browser.page.webApplicationPages();
  ...
  'Check that the deleted notification is not present in the application notification box': function (browser) {
    const webApp = browser.page.webApplicationPages();
