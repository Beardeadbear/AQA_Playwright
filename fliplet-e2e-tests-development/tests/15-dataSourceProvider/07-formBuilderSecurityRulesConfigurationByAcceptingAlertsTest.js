...
module.exports = {
  ...
  before: function(browser, done){
    browser.globals.appNameGenerated = `${casual.title} 07-form-ds-provider`;
    browser.globals.dataSourceNameGenerated = `${casual.title} 07-form-ds-provider`;
  ...
  'Create a new application, create a new app data source with no columns and security rules, add Form widget to the screen': function(browser){
    browser
  ...
  'Open the form settings and check that the data source provide is available if the connected and saved data has no columns': function(browser){
    const componentsScreen = browser.page.componentsScreen();
    const dataSourceProvider = browser.page.dataSourceProvider();
  ...
  'Enable Add new submissions to a data source and check that the security rules alert is shown': function(browser){
    const formBuilderPage = browser.page.formBuilderPage();
    const dataSourceProvider = browser.page.dataSourceProvider();
  ...
  'Enable Update existing entries in a data source and check that the security rules alert is shown': function(browser){
    const formBuilderPage = browser.page.formBuilderPage();
    const dataSourceProvider = browser.page.dataSourceProvider();
